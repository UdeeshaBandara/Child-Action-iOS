...
//        homeViewController.navigationItem.leftBarButtonItem = UIBarButtonItem.init(customView: label)
////        homeViewController.navigationController!.navigationBar.tintColor = .white
//        
//        let appearance = UINavigationBarAppearance()
//        appearance.configureWithOpaqueBackground()
//        appearance.backgroundColor = UIColor(named: "primary")
////        homeViewController.navigationItem.setRightBarButton(menuBarButton, animated: false)
//        homeViewController.navigationItem.standardAppearance = appearance
        ...
        naviCon.viewControllers = [sideMenuController]
